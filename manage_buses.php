...
$sql = "SELECT bus_id, busPhoto, plate_number, bus_driver_name,driver_contact_num, route, capacity, air_conditioned, created_at, updated_at, status FROM buses;";
    ...
    <script>
        $(document).ready(function() {
            $('table tbody tr').on('click', function() {
                ...
                if (modalStatus === 'full') {
                    $('.toggle-status').hide(); 
                    $('.toggle-status.unavailable, .toggle-status.available').show(); // Show available and unavailable options
                }
